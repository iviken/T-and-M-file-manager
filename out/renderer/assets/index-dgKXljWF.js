...
const _hoisted_13$4 = { class: "address-box" };
...
const _hoisted_22$2 = { class: "block on-col" };
const _hoisted_23$2 = { class: "" };
const _hoisted_24$2 = ["onClick"];
const _hoisted_25$2 = { class: "t-tree-item uppercase text-nowrap" };
const _hoisted_26$2 = {
  key: 1,
  class: "rename"
};
const _hoisted_27$2 = ["v-model", "id"];
const _hoisted_28$2 = { class: "block on-col" };
const _hoisted_29$2 = { class: "" };
const _hoisted_30$2 = { class: "list-item item on-row w100" };
const _hoisted_31$2 = ["onClick"];
const _hoisted_32$2 = { class: "t-tree-item text-nowrap uppercase text-nowrap" };
const _hoisted_33$2 = {
  key: 1,
  class: "rename"
};
const _hoisted_34$2 = ["v-model", "id"];
const _hoisted_35$2 = { class: "new-folder rename w100" };
const _hoisted_36$2 = ["v-model"];
const _hoisted_37$2 = {
  key: 2,
  class: "special-folders block on-col"
};
const _hoisted_38$2 = { class: "on-row item" };
const _hoisted_39$2 = { class: "on-row item" };
const _hoisted_40$2 = {
  key: 3,
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("div", _hoisted_12$4, [
        ...
        createBaseVNode("div", _hoisted_14$4, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.getPathForAddressBar, (part, index) => {
            return openBlock(), createElementBlock("div", _hoisted_15$2, [
              createBaseVNode("div", {
                onClick: ($event) => $options.clickToAddressBarPart({ path: $props.path.split("/").slice(0, index + 1).join("/") }),
      ...
      createBaseVNode("div", {
        ...
        $props.dataSettings.showFoldersStartingWithDot ? (openBlock(), createElementBlock("img", _hoisted_19$2)) : (openBlock(), createElementBlock("img", _hoisted_20$2))
      ])
    ]),
    createBaseVNode("div", _hoisted_21$2, [
      createBaseVNode("div", _hoisted_22$2, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.foldersMethods2.getFoldersList(), (item) => {
          return openBlock(), createElementBlock("div", _hoisted_23$2, [
            $data.nameOfTheFolderToBeRenamed != item ? (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", null, [
                createBaseVNode("span", _hoisted_25$2, toDisplayString($props.foldersMethods2.shrinkName(item, $data.settings.folderNameMaxLength)), 1)
              ]),
            ...
            ], 42, _hoisted_24$2)) : (openBlock(), createElementBlock("div", _hoisted_26$2, [
      ...
      createBaseVNode("div", _hoisted_28$2, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.foldersMethods2.getSubfoldersList(), (item) => {
          return openBlock(), createElementBlock("div", _hoisted_29$2, [
            createBaseVNode("div", _hoisted_30$2, [
              ...
              $data.nameOfTheFolderToBeRenamed != item ? (openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_32$2, toDisplayString($props.foldersMethods2.shrinkName(item, $data.settings.folderNameMaxLength)), 1)
              ], 8, _hoisted_31$2)) : (openBlock(), createElementBlock("div", _hoisted_33$2, [
                createBaseVNode("input", {
                  type: "text",
                  placeholder: "folder name",
                  "v-model": $data.renameValue,
      ...
      createBaseVNode("div", _hoisted_35$2, [
        $data.isCreatredNewFolder ? (openBlock(), createElementBlock("input", {
          key: 0,
          type: "text",
          ...
          class: "t-tree-item t-tree-renaming rename-input uppercase focus w100"
        }, null, 40, _hoisted_36$2)) : createCommentVNode("", true)
      ])
    ]),
    $data.settings[this.localState.actualSessionType].showSpecialFoldersBtns ? (openBlock(), createElementBlock("div", _hoisted_37$2, [
      createBaseVNode("div", _hoisted_38$2, [
        _cache[44] || (_cache[44] = createBaseVNode("div", { class: "left-field" }, [
          createBaseVNode("img", {
            src: _imports_8,
            alt: "my documents",
            class: "pix-btn docs"
        ...
        createBaseVNode("div", {
          onClick: _cache[17] || (_cache[17] = ($event) => $props.foldersMethods2.clickToSpecialFolder("Documents")),
          class: "list-item"
        }, _cache[43] || (_cache[43] = [
      ...
      createBaseVNode("div", _hoisted_39$2, [
        _cache[46] || (_cache[46] = createBaseVNode("div", { class: "left-field" }, [
          createBaseVNode("img", {
            src: _imports_9,
            alt: "downloads",
            class: "pix-btn loads"
        ...
        createBaseVNode("div", {
          onClick: _cache[18] || (_cache[18] = ($event) => $props.foldersMethods2.clickToSpecialFolder("Downloads")),
          class: "list-item"
        }, _cache[45] || (_cache[45] = [
...
function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
  return !$data.isRemaned ? (openBlock(), createElementBlock("div", {
    key: 0,
    onKeyup: _cache[7] || (_cache[7] = withKeys(withModifiers(($event) => $options.pinTask($props.task.id), ["ctrl"]), ["d"])),
    ...
    createBaseVNode("div", _hoisted_3$6, [
      createBaseVNode("div", {
        ...
        onDblclick: _cache[3] || (_cache[3] = ($event) => $options.renameTask({ state: "input-start", name: $props.task.name })),
        class: "task"
      }, [
    ...
    withDirectives(createBaseVNode("input", {
      ...
      "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => $data.renamedValue = $event),
      id: `${$props.task.id}`,
      onKeyup: [
        _cache[9] || (_cache[9] = withKeys(($event) => $data.isRemaned = false, ["esc"])),
        _cache[10] || (_cache[10] = withKeys(($event) => $options.renameTask({ state: "input-done" }), ["enter"]))
      ],
...
const TaskItem = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$8], ["__scopeId", "data-v-6c471c0c"]]);
const _sfc_main$7 = {
  components: {
    TaskItem
  },
...
const Tasks = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__scopeId", "data-v-ab3a175e"]]);
...
const _hoisted_32$1 = { class: "search on-center w100" };
const _hoisted_33$1 = { class: "marks-box__item menu on-row w100" };
const _hoisted_34$1 = { class: "vertical-center checkbox-block menu-item h100" };
const _hoisted_35$1 = ["onUpdate:modelValue"];
const _hoisted_36$1 = ["onClick", "onDblclick"];
const _hoisted_37$1 = {
  key: 1,
  class: "on-center"
};
const _hoisted_38$1 = { key: 0 };
const _hoisted_39$1 = { class: "marks-menu-clr-pic on-row h100" };
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    createBaseVNode("div", {
      onKeyup: [
        _cache[21] || (_cache[21] = withKeys(($event) => $options.pressEscOnBar(), ["esc"])),
        _cache[22] || (_cache[22] = withKeys(withModifiers(($event) => $props.foldersMethods2.openClosedTab(), ["ctrl"]), ["t"]))
      ],
      tabindex: "0",
      class: "bar on-center focus"
    }, [
        ...
        createBaseVNode("div", _hoisted_7$4, [
          ...
          createBaseVNode("div", _hoisted_8$4, [
            ...
            !$data.state.showTextarea ? (openBlock(), createElementBlock("div", _hoisted_9$3, [
              ...
              _cache[32] || (_cache[32] = createBaseVNode("label", { for: "picker" }, [
      ...
      !$props.localState.metadataIsHidden && !$props.localState.showImageProcessor ? (openBlock(), createElementBlock("div", _hoisted_24$1, [
        createBaseVNode("div", _hoisted_25$1, [
          ...
          _cache[36] || (_cache[36] = createBaseVNode("span", { class: "meta-item text-nowrap" }, "Created: ", -1)),
          ...
          _cache[37] || (_cache[37] = createBaseVNode("span", { class: "meta-item text-nowrap" }, "Last edited: ", -1)),
      ...
      $props.localState.showImageProcessor ? (openBlock(), createElementBlock("div", _hoisted_31$1, " image processor... ")) : createCommentVNode("", true),
      createBaseVNode("div", _hoisted_32$1, [
        withDirectives(createBaseVNode("input", {
          type: "text",
          placeholder: "search",
          "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => $data.state.searchValue = $event),
          onInput: _cache[18] || (_cache[18] = ($event) => $options.search()),
          onKeyup: _cache[19] || (_cache[19] = withKeys(($event) => $options.searchAll(), ["enter"])),
          onClick: _cache[20] || (_cache[20] = ($event) => $data.state.searchValue = ""),
          id: "search",
          class: "search-input t-bar-search on-center focus w100"
        }, null, 544), [
          [vModelText, $data.state.searchValue]
    ...
    createBaseVNode("div", {
      onKeyup: _cache[28] || (_cache[28] = withKeys(($event) => $options.abortMarkEdit(), ["esc"])),
      onMouseleave: _cache[29] || (_cache[29] = ($event) => $data.state.marksBoxIsFolded = true),
      ...
      createBaseVNode("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.marks, (item) => {
          return openBlock(), createElementBlock("div", _hoisted_33$1, [
            ...
            ], 42, _hoisted_36$1)) : (openBlock(), createElementBlock("div", _hoisted_37$1, [
              !$data.state.showColorPicker ? (openBlock(), createElementBlock("div", _hoisted_38$1, [
                withDirectives(createBaseVNode("input", {
                  type: "text",
                  placeholder: "mark name",
                  "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => $data.state.markNewName = $event),
                  onKeyup: _cache[24] || (_cache[24] = withKeys(($event) => $options.renameMark({ state: "end rename", newName: $data.state.markNewName }), ["enter"])),
            ...
            createBaseVNode("div", _hoisted_39$1, [
              $data.state.showColorPicker && $props.marksMethods.state.markRenameID == item.id ? (openBlock(), createElementBlock("div", {
                key: 0,
                onClick: _cache[26] || (_cache[26] = ($event) => $data.state.showColorPicker = false),
                class: "color-pic on-row"
              }, [
                (openBlock(true), createElementBlock(Fragment, null, renderList($data.settings.availableMarkColors, (clr) => {
                  return openBlock(), createElementBlock("div", {
                    onClick: _cache[25] || (_cache[25] = ($event) => $props.marksMethods.state.markRenameID = null),
                    class: "h100"
                  }, [
                    createBaseVNode("div", {
                      onClick: ($event) => item.color = clr,
                      class: normalizeClass([`color-pic-${clr}`, "clr-pic-item clr-pic-box-menu-bar h100"])
                    }, null, 10, _hoisted_40$1)
                  ]);
                }), 256))
              ])) : createCommentVNode("", true),
              item.id != $props.stateFiles.defaults.unmarkedMarkID ? (openBlock(), createElementBlock("div", _hoisted_41, [
                withDirectives(createBaseVNode("input", {
                  type: "checkbox",
                  "onUpdate:modelValue": _cache[27] || (_cache[27] = ($event) => $data.state.showColorPicker = $event),
                  id: "picker",
                  name: "picker",
                  class: "checkbox"
                }, null, 512), [
            ...
            !$data.state.showColorPicker ? (openBlock(), createElementBlock("div", _hoisted_44, [
...
const Bar = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__scopeId", "data-v-925c191a"]]);
const _sfc_main$5 = {
  props: {
    file: {
      type: Object,
  ...
  refreshFolders: function(path, cnst, data) {
    ...
    function sublist(path2, cnst2) {
      ...
      if (!folders.parameters.showFoldersStartingWithDot) {
        if (!paths.getFolderName(path2).startsWith("."))
...
const BrowserView = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__scopeId", "data-v-db509a72"]]);
const _sfc_main$2 = {};
const _hoisted_1$2 = { class: "help" };
function _sfc_render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$2, " Help ");
}
const HelpView = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__scopeId", "data-v-2a7116fe"]]);
const _sfc_main$1 = {
  methods: {
